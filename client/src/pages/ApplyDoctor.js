...
function ApplyDoctor() {
    ...
    return (
        <Layout><h1 className='page-title'>Apply Doctor</h1>
            <hr />
            <Form layout='vertical' onFinish={onFinish}>
                <h1 className="cards-title mt-3">Personal Information</h1>
                <Row gutter={20}>
                ...
                <hr />
                <h1 className="cards-title mt-3">Professional Information</h1>
                <Row gutter={20}>
                    <Col span={8} xs={24} sm={24} lg={8}>
